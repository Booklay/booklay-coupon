...
public class MemberAspect {
     ...
     */
    @Around("@annotation(org.springframework.web.bind.annotation.GetMapping) && execution(* *.*(.., com.nhnacademy.booklay.booklaycoupon.dto.common.MemberInfo, ..))")
     ...
     */
    @Around("@annotation(org.springframework.web.bind.annotation.PostMapping) && execution(* *.*(.., com.nhnacademy.booklay.booklaycoupon.dto.common.MemberInfo, ..))")
