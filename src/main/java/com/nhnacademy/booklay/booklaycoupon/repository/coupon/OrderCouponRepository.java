...
public interface OrderCouponRepository extends JpaRepository<OrderCoupon, Long>, OrderCouponCustomRepository {
    Page<CouponRetrieveResponseFromProduct> findAllByMember_MemberNoAndCoupon_IsDuplicatableAndCoupon_CategoryNoNotNullAndIsUsedAndExpiredAtAfter(
        Long memberNo, Boolean isDuplicatable, boolean isUsed, LocalDateTime expiredAt,
        Pageable pageable);
    ...
    List<CouponRetrieveResponseFromProduct> findAllByCodeInAndMemberNoAndOrderNoIsNull(
    ...
    boolean existsByIsUsedAndIdAndMemberNo(boolean isUsed, Long id, Long memberNo);
}
